import boxImg from "@/assets/product-box.webp";
import portasImg from "@/assets/product-portas.webp";
import espelhosImg from "@/assets/product-espelhos.webp";
import projetosImg from "@/assets/product-projetos.webp";
import heroBox from "@/assets/hero-box.webp";
...
import transferCover from "@/assets/transfer-cover.webp";
...
import portaCerta from "@/assets/porta-certa.webp";
...
import projetoEscritorios from "@/assets/escritorio-interior.webp";
import comercialInterior from "@/assets/comercial-interior.webp";
import projetoGuardaCorpo from "@/assets/projeto-guarda-corpo.webp";
import projetoFechamentoSacada from "@/assets/projeto-fechamento-sacada.webp";
import projetoCoberturas from "@/assets/projeto-coberturas.webp";
...
export const CATEGORIES: Record<string, Category> = {
  "box-de-banheiro": {
    ...
    models: [
      ...
      { slug: "abrir", name: "Box de Abrir", description: "Porta de giro em vidro temperado, ideal para vãos pequenos.", longDescription: "O Box de Abrir (porta de giro) é a solução clássica para vãos estreitos onde não há espaço para folhas de correr. Com vidro temperado de 8mm e dobradiças cromadas, abre para fora liberando até 90% do vão — perfeito para banheiros pequenos com área livre na frente.", image: portaDeGiro, gallery: placeholderGallery(portaDeGiro) },
    ],
  },
  "portas-de-vidro": {
