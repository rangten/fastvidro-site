        ...
        <div className="mt-12 flex justify-center">
          ...
          >
            <svg viewBox="0 0 32 32" className="h-6 w-6 fill-current" aria-hidden="true">
              <path d="M19.11 17.205c-.372 0-1.088 1.39-1.518 1.39a.63.63 0 0 1-.315-.094c-.93-.461-1.八.997-2.578-1.九 0 0-.04-.06-.07-.107-.05-.082-.05-.08-.05-.08-.07-.1-.07-.1-.05-.08-.05-.08-.07-.1-.05-.08z" />
