...
import cover from "@/assets/blog-box-tradicional-vs-flex-cover.png";
          ...
          <div className="prose-content mt-8 space-y-6 text-[17px] leading-relaxed text-foreground/90">
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                ...
                <Link to="/servicos/butanta" className="text-primary hover:underline font-bold">Butantã</Link> e Jaguaré.
              </li>
              <li>
              ...
              <li>
                ...
                <Link to="/servicos/vila-guilherme" className="text-primary hover:underline font-bold">Vila Guilherme</Link> e{" "}
              ...
              <li>
                ...
                <Link to="/servicos/vila-formosa" className="text-primary hover:underline font-bold">Vila Formosa</Link>,{" "}
                Belenzinho e Penha.
              </li>
              <li>
                ...
                <Link to="/servicos/higienopolis" className="text-primary hover:underline font-bold">Higienópolis</Link>,{" "}
