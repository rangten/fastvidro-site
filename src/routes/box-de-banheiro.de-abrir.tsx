...
const META_DESC =
  "Box de Abrir (porta de giro) em vidro temperado 8mm na Zona Norte e toda São Paulo. Ideal para vãos pequenos. Medição técnica gratuita e instalação rápida. Peça orçamento!";

const WA_MSG = "Olá! Quero um orçamento do Box de Abrir (porta de giro) com a Fast Vidro.";
const WA_URL = `https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent(WA_MSG)}`;

const gallery = [imgAbrir, imgCorrer, imgCanto];

export const Route = createFileRoute("/box-de-banheiro/de-abrir")({
  head: () => ({
    meta: [
      { title: META_TITLE },
  ...
  component: BoxDeAbrirPage,
});

function BoxDeAbrirPage() {
  return (
    <SiteLayout>
      {/* Hero */}
      <section className="relative overflow-hidden bg-ink text-ink-foreground">
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-16 lg:px-8 lg:py-24">
          ...
          <span className="mt-6 block speed-line text-xs font-bold uppercase tracking-[0.3em] text-primary">
            Box de Abrir • São Paulo
          </span>
          <h1 className="mt-3 text-4xl sm:text-5xl lg:text-6xl font-black leading-[0.95]">
            Box de Abrir em São Paulo: Porta de Giro em Vidro Temperado para Vãos Pequenos
          </h1>
          <p className="mt-5 max-w-2xl text-base text-ink-foreground/80">
            O Box de Abrir (porta de giro) é a solução clássica para vãos estreitos onde não há
            espaço para folhas de correr. Vidro temperado de 8mm e dobradiças cromadas — abre para
            fora liberando até 90% do vão.
          </p>
          <a
            href={WA_URL}
            target="_blank"
          ...
          >
            <MessageCircle className="h-4 w-4" /> Solicitar orçamento do Box de Abrir
          </a>
        </div>
      </section>
      ...
      <section className="mx-auto max-w-4xl px-4 py-16 lg:px-8 lg:py-20">
        <article className="prose-fast">
          <p className="text-base leading-relaxed text-foreground/90">
            Se o seu banheiro é compacto e não dispõe de espaço livre nas laterais para o
            deslizamento de folhas de correr, a <strong>Fast Vidro</strong> tem a solução ideal.
            Somos a sua grande referência em <strong>box de vidro</strong> e especialista em{" "}
            <strong>box de banheiro na Zona Norte de São Paulo</strong> e demais regiões da
            capital. O <strong>Box de Abrir</strong> (também conhecido como box com porta de giro)
            é a escolha perfeita para quem precisa aproveitar ao máximo cada centímetro do vão do
            chuveiro sem abrir mão da segurança e do acabamento premium.
          </p>
          <p className="mt-5 text-base leading-relaxed text-foreground/90">
            O grande diferencial deste modelo está na sua abertura por giro. A porta de vidro
            temperado pivotada sobre dobradiças cromadas de alta resistência{" "}
            <strong>abre para fora do box</strong>, liberando até 90% do vão de passagem. Isso
            elimina a necessidade de trilhos horizontais e permite o uso total da largura interna
            do box — fundamental em banheiros pequenos, lavabos e suítes onde a área livre na
            frente é limitada.
          </p>

          <h2 className="mt-12 text-3xl font-black">
            Vidro Temperado de 8mm e Ferragens de Alta Resistência
          </h2>
          <p className="mt-4 text-base leading-relaxed text-foreground/90">
            O Box de Abrir da Fast Vidro é produzido rigorosamente sob medida com painéis de{" "}
            <strong>vidro temperado de 8mm de espessura</strong>, certificado e com resistência
            mecânica até cinco vezes superior à do vidro comum. As dobradiças são fabricadas em
            latão maciço cromado, com regulagem de alinhamento e fechamento suave, garantindo
            durabilidade mesmo em uso diário intenso e na exposição constante à umidade do
            chuveiro.
          </p>
          <p className="mt-5 text-base leading-relaxed text-foreground/90">
            Para se adequar perfeitamente ao estilo do seu ambiente, disponibilizamos o Box de
            Abrir em diversas opções de cores de vidro (como Incolor, Fumê e Bronze) e acabamentos
            para as dobradiças e perfis, incluindo <strong>Branco, Preto, Cromado e Dourado</strong>.
            Toda instalação é precedida por uma medição técnica digital a laser, garantindo o prumo
            perfeito e vedação total contra vazamentos de água.
          </p>
          ...
          <p className="mt-4 text-base leading-relaxed text-foreground/90">
            ...
            <strong>box de banheiro na Zona Norte de São Paulo</strong> — atendendo com pontualidade
            e rapidez bairros tradicionais como{" "}
            <strong>
          ...
          <p className="mt-5 text-base leading-relaxed text-foreground/90">
            Oferecemos o melhor preço de fábrica e as melhores condições de pagamento da região.
            Nossa equipe técnica atende com total agilidade nas seguintes áreas:
          </p>
          ...
          <p className="mt-6 text-base leading-relaxed text-foreground/90">
            Garanta um box de abrir seguro, bonito e instalado por profissionais qualificados. Fale
      ...
      <section className="bg-ink text-ink-foreground py-16 lg:py-20">
        <div className="mx-auto max-w-7xl px-4 lg:px-8">
          ...
          <h2 className="mt-3 text-3xl lg:text-4xl font-black">Box de Abrir instalado em SP</h2>
